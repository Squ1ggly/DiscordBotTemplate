...
module.exports = {
  ...
  async execute(interaction: any, client: any) {
    try {
      const author: EmbedAuthorData = { name: "TESTBOT", iconURL: "https://sparkcdnwus2.azureedge.net/sparkimageassets/XPDC2RH70K22MN-08afd558-a61c-4a63-9171-d3f199738e9f" };
